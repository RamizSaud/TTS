...
def create_mels():
    ...
    def save_mel(filename):
        ...
        # print(f"Audio shape after unsqueeze: {audio_norm.shape}")
...
if  __name__ == '__main__':
    ...
    hparams.training_files = "filelists/metadata_final.txt"
    hparams.validation_files = "filelists/metadata_val.txt"
    ...
    output_directory = 'D:\\GIKI\\6th Semester\\AI361\Project\\Implementation\\tacotron2\\output' # Location to save Checkpoints
    log_directory = 'D:\\GIKI\\6th Semester\\AI361\Project\\Implementation\\tacotron2\\logs' # Location to save Log files locally
    log_directory2 = 'D:\\GIKI\\6th Semester\\AI361\Project\\Implementation\\tacotron2\\logs2' # Location to copy log files (done at the end of each epoch to cut down on I/O)
